...
distance = 3 # Distance betweeen molecules
...
#dyn = VelocityVerlet(water, 0.1*units.fs)
#if rank == 0:
    #visuals = AtomEyeViewer(water, "/home/himanel1/water")
