...
binding.set_potentials(Potential('LJ', cutoff=4.0, symbols=['H', 'H'], parameters=[0.1, 2.5]))
ewald_param = estimate_ewald_parameters(1, 'high')
binding.set_coulomb_interaction(sigma=ewald_param[2], k_cutoff=ewald_param[1], real_cutoff=ewald_param[0])
