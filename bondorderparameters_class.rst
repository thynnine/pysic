...
:class:`~pysic.Potential`, and :class:`~pysic.Pysic` with::
...
The coordiantion scaling function is defined as
...
In other words, the bond order factor only overrides the scaling function of another
bond order factor when mixed. Especially, it is zero if not paired with other bond order factors.
Formally, it is a 1-body bond order factor.
...
.. file:bondorderparameters_class: autogenerated
...
.. only:: html
  ...
  - :meth:`~pysic.BondOrderParameters.expand_symbols_table`
